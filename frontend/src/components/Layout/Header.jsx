  ...
  return (
    <>
        ...
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          ...
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-[#17252A] border-[2px] rounded-md"
            />
            <AiOutlineSearch
              size={30}
          ...
          <div className={`${styles.button}`}>
            <Link to={`${isSeller ? "/dashboard" : "/shop-create"}`}>
              <h1 className="text-[#FEFFFF] flex items-center">
                {isSeller ? "Go Dashboard" : "Register"}{" "}
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#3AAFA9] h-[70px]`}
      >
        <div
        ...
        >
          ...
          <div onClick={() => setDropDown(!dropDown)}>
            <div className="relative h-[60px] mt-[10px] w-[270px] hidden 1000px:block">
              ...
              <button
                className={`h-[100%] w-full flex justify-between items-center pl-10 bg-[#FEFFFF] font-sans text-lg font-[500] select-none rounded-t-md`}
              >
                Categories
              </button>
              <IoIosArrowDown
